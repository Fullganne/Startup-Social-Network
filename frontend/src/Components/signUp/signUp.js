    ...
    const handleSignup = async () => {
        try {
            ...
            if (!password.trim()) {
                ...
                validationErrors.password = 'Password cần ít nhất 6 kí tự, chữ hoa, thường và kí tự đặc biệt!';
            }
    ...
    <div className='body'>
        <div className='container'>
            ...
            <div className='inputs'>
                ...
                <div className='flex w-[80%] m-auto px-5'>
                    {errors.password && <span className="error text-red-500 text-left">{errors.password}</span>}
                </div>
            </div>
