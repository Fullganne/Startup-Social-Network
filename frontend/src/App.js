...
function App() {
  ...
  return (
    ...
    <div>
    <div className="flex">
       {window.location.href.includes("/home")||window.location.href.includes("/user")||window.location.href.includes("/search")?( <div className='w-[18.5%] border border-l-slate-500'>
            <Sidebar/>
        </div>):""}
